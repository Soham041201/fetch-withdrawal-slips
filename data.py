...
def get_data(file_name):
    ...
    signatureFile = extract_signature(file_name)
    logo = ''
    ...
    acc_number = preprocess_data(
        'account_number.jpg', 'pre_account_number.jpg')
    return date, ammount, acc_number, logo, signatureFile
